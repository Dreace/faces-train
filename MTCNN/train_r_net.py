...
from core.models import RNet
from utils.logger import logger


def train_r_net(model_path, end_epoch, image_db, image_db_validate,
    ...
    optimizer = torch.optim.Adam(net.parameters(), lr=base_lr, weight_decay=1e-5)
...
if __name__ == '__main__':
    ...
    train_r_net(model_path=args.model_path, end_epoch=args.end_epoch, image_db=gt_image_db,
